            ...
            <div className='container-login'>
                <div className='row-login'>
                    <div className='col-login'>
                        <img src="https://img.freepik.com/premium-vector/online-registration-illustration-design-concept-websites-landing-pages-other_108061-938.jpg" className='login-img' alt="" />
                    </div>
                    <div className='col-login'>
