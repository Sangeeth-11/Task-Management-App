      ...
      <div className='container-register'>
                <div className='row-register'>
                    <div className='col-register'>
                        <img src="https://img.freepik.com/premium-vector/illustration-vector-graphic-cartoon-character-online-registration_516790-1807.jpg?semt=ais_hybrid" className='register-img' alt="" />
                    </div>
                    <div className='col-register'>
